    ...
    >
      ...
      <div className="mx-[56px] mt-[50px] flex items-center">
        <div className="ml-1 mt-1 h-2.5 font-poppins text-[26px] font-bold uppercase text-navy-700 dark:text-white">
          <img src="/light-logo.png" alt="Light Mode Logo" className="h-14 w-15 block dark:hidden" />
          <img src="/horizonplay.svg" alt="Dark Mode Logo" className="h-14 w-15 hidden dark:block" />
        </div>
      </div>
