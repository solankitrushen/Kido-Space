        ...
        <div className="mx-auto w-full max-w-2xl overflow-hidden rounded-lg bg-white shadow-lg dark:bg-navy-900">
          ...
          <div className="p-6 text-left dark:text-white bg-navy-800">
            ...
            <div className="space-x-4 ">
              ...
              <button
                className="h-12 rounded-md bg-purple-600 px-4 py-2 text-white hover:bg-purple-700"
                onClick={resetQuiz}
              >
                Retry
              </button>
              {!passed && (
                <button
                  className="h-12 rounded-md bg-blue-500 px-4 py-2 text-white hover:bg-blue-600"
                  onClick={startReview}
                >
                  Review Answers
                </button>
